...
# Build images
docker build -t meacedric/multi-client:latest meacedric/multi-client:$SHA  -f ./client/Dockerfile ./client
docker build -t meacedric/multi-server:latest meacedric/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t meacedric/multi-worker:latest meacedric/multi-worker:$SHA-f ./worker/Dockerfile ./worker
